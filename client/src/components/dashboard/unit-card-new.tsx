        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-6">
          ...
          <div className="bg-slate-50 rounded-lg p-2 sm:p-3">
            <div className="flex items-center mb-1 sm:mb-2">
              <svg className="w-3 sm:w-4 h-3 sm:h-4 mr-1 sm:mr-2 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
              </svg>
              <p className="text-[10px] sm:text-xs font-medium text-slate-600">Temperature</p>
            </div>
